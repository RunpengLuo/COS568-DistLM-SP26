#!/bin/bash
# Task 4: Profile all_reduce (4 nodes, skip 1st step, profile 3 steps)
# Run locally — SSHes into all 4 CloudLab nodes in parallel.
# Usage: bash scripts/run_task4_all_reduce.sh
...
echo "=== Launching Task 4 profile (all_reduce) on 4 nodes ==="
for i in 0 1 2 3; do
...
echo "=== Task 4 (all_reduce) profiling complete ==="
