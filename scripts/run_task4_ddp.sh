#!/bin/bash
# Task 4: Profile DDP (4 nodes, skip 1st step, profile 3 steps)
# Run locally — SSHes into all 4 CloudLab nodes in parallel.
# Usage: bash scripts/run_task4_ddp.sh
...
echo "=== Launching Task 4 profile (DDP) on 4 nodes ==="
for i in 0 1 2 3; do
...
RESULTS_DIR="$SCRIPT_DIR/results/task4_ddp"
mkdir -p "$RESULTS_DIR"
...
echo "=== Task 4 (DDP) profiling complete ==="
